                ...
                private void FixedUpdate()
                {
                    ...
                    if (eye_callback_registered)
                    {
                        if (SRanipal_Eye_v2.GetGazeRay(GazeIndex.COMBINE, out GazeOriginCombinedLocal,
                                out GazeDirectionCombinedLocal, eyeData))
                        {
                        }
                    ...
                    GazeRayRenderer.SetPosition(1,
                        Camera.main.transform.position + GazeDirectionCombined * LengthOfRay);
                    
                    ray = new Ray(Camera.main.transform.position - Camera.main.transform.up * 0.05f,
                        Camera.main.transform.position + GazeDirectionCombined * LengthOfRay);
                }
